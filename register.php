...
if (!empty($_POST)) {
    ...
    $query = "INSERT INTO tie_table( id,name,desc,image_url,you_key ) VALUES ( :id, :name,:desc, :image_url, :you_key ) ";
...
Youtube Key:<br /> 
 ...
 <input type="Insert" value="Insert new tie data" /> 
